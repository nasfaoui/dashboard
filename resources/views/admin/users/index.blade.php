                ...
                @foreach ($users as $item)
                    <tr class="table-active">
                        ...
                        <td class=" text-center">
                            ...
                            <a class="btn btn-info btn-sm " href="{{ route('adminUsers.edit', $item->id) }}">
                                <span><i class="align-middle " data-feather="edit-2"></i> </span></a>
                            <a  class="btn btn-primary btn-sm m-1 " href="{{ route('adminUsers.show', $item->id) }}">
