...
@section('content')
    <div class="container  ">
        ...
        <div class=" d-flex justify-content-center">
               ...
               <div class=" justify-content-center align-items-center ">
                    <form action="{{route('service.post')}}" method="post"   enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="title" class="form-control" name="title" id="exampleFormControlInput1" value="{{ old('title') }}" placeholder="Titre de l'annonce">
                            @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="price" id="exampleFormControlInput1" value="{{ old('price') }} placeholder="à partir de ... ">
                            @error('price')
                            <div class="text-danger">
                                {{$message}}
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="exampleFormControlTextarea1" name="description" value="{{ old('description') }}" cols="50" rows="6" ></textarea>
                            @error('description')
                            <div class="text-danger">
                                {{$message}}
                            </div>
                        @enderror
                            ...
                            <div class="d-grid ">
                                    ...
                                    <button type="submit" class=" btn-block  btn btn-primary" >AJOUTER L'ANNONCE</button>
            ...
            {{-- Conseils pour accepter le service --}}
